    ...
    function CardcontainerComponent(dragulaService, fhirService, resourceCodeManager, snackBar, deleteDialog, setupDataService) {
        ...
        if (!String.prototype.padStart) {
            String.prototype.padStart = function padStart(targetLength, padString) {
                padString =
                    String((typeof padString !== 'undefined' ? padString : ' '));
                if (this.length > targetLength) {
                    ...
                    if (targetLength > padString.length) {
                        padString += padString.repeat(targetLength /
                            padString.length); // append to original to ensure we are
                        // longer than needed
                    }
...
var CustomizableTimelineDialogComponent = /** @class */ (function () {
    ...
    CustomizableTimelineDialogComponent.prototype.getSelectedDate = function () {
        ...
        console.log(luxon__WEBPACK_IMPORTED_MODULE_4__["DateTime"].fromHTTP(this.dateFormControl.value));
...
module.exports = __webpack_require__(/*! /usr/local/google/home/shilpakumar/workspaceGithub/medtimeline/medtimeline/src/main.ts */"./src/main.ts");
